...
export default function CollaborativeTextEditor({
  ...
  const { validate, diagnostics, isValidating, hasValidated, clearDiagnostics, navigateTo } =
  ...
  useEffect(() => {
    onValidatorReady?.({ validate, diagnostics, isValidating, hasValidated, clearDiagnostics, navigateTo })
  }, [validate, diagnostics, isValidating, hasValidated, clearDiagnostics, navigateTo, onValidatorReady])
