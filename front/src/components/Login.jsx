    ...
    <>
      ...
      <section className={styles.box}>
        ...
        <form onSubmit={handleSubmit} className={styles.loginForm}>
          <fieldset>
            <legend>
            {t("credentials.login.withRemoteAccount")} <small>({t("credentials.login.recommendedMethod")})</small>
            </legend>
            ...
            <p>
              ...
              >
                {t("credentials.login.registerWithService", { name: 'Huma-Num'})}
              </a>
            </p>
          ...
          <fieldset>
            ...
            <ul className={styles.actions}>
              <li>
                <Link to="/register">{t("credentials.login.registerLink")}</Link>
              </li>
